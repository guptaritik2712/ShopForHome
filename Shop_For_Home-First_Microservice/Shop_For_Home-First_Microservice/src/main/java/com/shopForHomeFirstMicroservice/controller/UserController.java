...
import com.shopForHomeFirstMicroservice.request.LoginForm;
import com.shopForHomeFirstMicroservice.response.JwtResponse;
import com.shopForHomeFirstMicroservice.securityJWT.JwtProvider;
import com.shopForHomeFirstMicroservice.service.UserService;
...
public class UserController {
	...
	@DeleteMapping(value="deleteuserbyemail/{email}")
	public void deleteproductbyname(@PathVariable("email") String email) {
